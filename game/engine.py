...
class GameEngine:
    ...
    def run_exploit(self, exploit_id: str, target_id: str = None, minigame_score: float = 1.0):
        ...
        base_probs = {
            ...
            # Chapter 5 / forensics steps
            "archive_access":   [0.90, 0.85, 0.75, 0.55, 0.30],
            "pcap_filter":      [0.95, 0.92, 0.88, 0.80, 0.65],
            "timeline_build":   [0.95, 0.90, 0.85, 0.78, 0.65],
            "evidence_package": [0.95, 0.92, 0.90, 0.85, 0.75],
            "implant_capture":  [0.85, 0.78, 0.65, 0.48, 0.28],
            "c2_trace":         [0.88, 0.80, 0.68, 0.50, 0.30],
            "origin_id":        [0.82, 0.74, 0.60, 0.42, 0.22],
            "evidence_extract": [0.88, 0.80, 0.68, 0.52, 0.30],
            "secure_handoff":   [0.95, 0.90, 0.85, 0.78, 0.65],
            "opsec_audit":      [0.95, 0.92, 0.88, 0.82, 0.70],
            "metadata_scrub":   [0.95, 0.92, 0.90, 0.85, 0.75],
            "relay_rebuild":    [0.90, 0.85, 0.78, 0.65, 0.48],
            "verify_clean":     [0.95, 0.92, 0.88, 0.82, 0.70],
