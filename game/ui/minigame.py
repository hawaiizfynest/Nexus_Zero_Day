...
class MinigameController:
    ...
    GAME_MAP = {
        ...
        # Chapter 5 — forensics and OPSEC
        "archive_access":   "port_mapper",
        "pcap_filter":      "cipher_decoder",
        "timeline_build":   "cipher_decoder",
        "evidence_package": "port_mapper",
        "implant_capture":  "firewall_bypass",
        "c2_trace":         "port_mapper",
        "origin_id":        "cipher_decoder",
        "evidence_extract": "port_mapper",
        "secure_handoff":   "firewall_bypass",
        "opsec_audit":      "cipher_decoder",
        "metadata_scrub":   "cipher_decoder",
        "relay_rebuild":    "firewall_bypass",
        "verify_clean":     "port_mapper",
